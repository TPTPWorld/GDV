...
%           & ! [X3] :
%             ? [X4] : q(X1,X2,X3,X4) ) ),
%     introduced(definition,[new_symbols(skolem,[esk1_1]),parent(a1),skolemize(X2,esk1_1(X1))]) ).

fof(c_0_4b,plain,
    ! [X1] :
      ( p(X1,esk1_1(X1))
      & ! [X3] : q(X1,esk1_1(X1),X3,esk2_2(X1,X3)) ),
    inference(skolemization,[status(esa),new_symbols(skolem,[esk2_2]),skolemize(X4,esk2_2(X1,X3))],[c_0_4a]) ).
...
%     introduced(definition,[new_symbols(skolem,[esk2_2]),parent(c_0_4a),skolemize(X4,esk2_2(X1,X3))]) ).
