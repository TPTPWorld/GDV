...
ZenonModulo---0.4.2   checking problem name /tmp/apXrFmQGmq/SOT_KMAvHD

ZenonModulo---0.4.2's TPTP format /tmp/apXrFmQGmq/SOT_KMAvHD is ...
...
ZenonModulo---0.4.2's SOT_KMAvHD does not need preparation
ZenonModulo---0.4.2   will use /tmp/apXrFmQGmq/SOT_KMAvHD
...
ZenonModulo---0.4.2   being executed on SOT_KMAvHD using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/apXrFmQGmq/SOT_KMAvHD'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith   -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/apXrFmQGmq/SOT_KMAvHD > /tmp/tmp.YFO24BtVya/ZenonModulo_50646.s
% SZS status Theorem
% SZS output start Proof
require open Logic.Zenon.FOL Logic.Zenon.LL Logic.Zenon.ND Logic.Zenon.ND_eps Logic.Zenon.ND_eps_full Logic.Zenon.ND_eps_aux Logic.Zenon.LL_ND Logic.Zenon.zen;
require LAMBDAPI_CONTEXT.Signature as S;

rule S.coordinator_teaches ↪ 
...
RESULT: SOT_KMAvHD - ZenonModulo---0.4.2 says Theorem - CPU = 0.00 WC = 0.07 
OUTPUT: SOT_KMAvHD - ZenonModulo---0.4.2 says Proof - CPU = 0.00 WC = 0.07 
