...
E---3.1   checking problem name TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/c_0_13_thm.p

E---3.1's TPTP format TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/c_0_13_thm.p is ...
...
E---3.1's c_0_13_thm does not need preparation
E---3.1   will use TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/c_0_13_thm.p
...
E---3.1   being executed on c_0_13_thm using /exp/home/tptp/Systems/E---3.1/run_E 'TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/c_0_13_thm.p' 30 THM
% START OF SYSTEM OUTPUT
Running first-order theorem proving
Running: /exp/home/tptp/Systems/E---3.1/eprover --delete-bad-limit=2000000000 --definitional-cnf=24 -s --print-statistics -R --print-version --proof-object --auto-schedule=8 --cpu-limit=30 /tmp/tmp.DeDULDUAqp/E---3.1_51637
# Version: 3.1pre001
...
# new_bool_1 with pid 51657 completed with status 0
...
# SAT001_MinMin_p005000_rr_RG with pid 51663 completed with status 0
...
tff(c_0_13, conjecture, enrolled(michael,csc410), file('/tmp/tmp.DeDULDUAqp/E---3.1_51637', c_0_13)).
tff(michael_enrolled_csc410_axiom, axiom, enrolled(michael,csc410), file('/tmp/tmp.DeDULDUAqp/E---3.1_51637', michael_enrolled_csc410_axiom)).
tff(c_0_16, negated_conjecture, ~enrolled(michael,csc410), inference(fof_simplification,[status(thm)],[inference(assume_negation,[status(cth)],[c_0_13])])).
tcf(c_0_17, negated_conjecture, ~enrolled(michael,csc410), inference(split_conjunct,[status(thm)],[c_0_16])).
tcf(c_0_18, plain, enrolled(michael,csc410), inference(split_conjunct,[status(thm)],[michael_enrolled_csc410_axiom])).
...
RESULT: c_0_13_thm - E---3.1 says Theorem - CPU = 0.07 WC = 0.10 
OUTPUT: c_0_13_thm - E---3.1 says CNFRefutation - CPU = 0.07 WC = 0.10 
