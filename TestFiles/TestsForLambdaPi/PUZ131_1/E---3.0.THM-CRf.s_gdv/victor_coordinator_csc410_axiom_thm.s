...
ZenonModulo---0.4.2   checking problem name /tmp/Yi4iREmgLL/SOT_pZbgpG

ZenonModulo---0.4.2's TPTP format /tmp/Yi4iREmgLL/SOT_pZbgpG is ...
...
ZenonModulo---0.4.2's SOT_pZbgpG does not need preparation
ZenonModulo---0.4.2   will use /tmp/Yi4iREmgLL/SOT_pZbgpG
...
ZenonModulo---0.4.2   being executed on SOT_pZbgpG using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/Yi4iREmgLL/SOT_pZbgpG'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith   -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/Yi4iREmgLL/SOT_pZbgpG > /tmp/tmp.fDj1y1S1P7/ZenonModulo_50762.s
% SZS status Theorem
% SZS output start Proof
require open Logic.Zenon.FOL Logic.Zenon.LL Logic.Zenon.ND Logic.Zenon.ND_eps Logic.Zenon.ND_eps_full Logic.Zenon.ND_eps_aux Logic.Zenon.LL_ND Logic.Zenon.zen;
require LAMBDAPI_CONTEXT.Signature as S;

rule S.victor_coordinator_csc410_axiom ↪ 
  nnpp ((S.coordinatorof (S.csc410)) =α (S.victor))
    (λ (v_Vm : ϵ (¬
 ((S.coordinatorof (S.csc410)) =α (S.victor)))),
 Raxiom
 ((S.coordinatorof (S.csc410)) =α (S.victor))
 (S.victor_coordinator_csc410_axiom_0018 )
 (v_Vm)
);
...
RESULT: SOT_pZbgpG - ZenonModulo---0.4.2 says Theorem - CPU = 0.00 WC = 0.08 
OUTPUT: SOT_pZbgpG - ZenonModulo---0.4.2 says Proof - CPU = 0.00 WC = 0.08 
