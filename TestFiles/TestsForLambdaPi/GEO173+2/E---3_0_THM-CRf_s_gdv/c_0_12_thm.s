...
ZenonModulo---0.4.2   checking problem name /tmp/tv_v2i2OLB/SOT_gUKYkR

ZenonModulo---0.4.2's TPTP format /tmp/tv_v2i2OLB/SOT_gUKYkR is ...
fof(c_0_8,axiom,
...
ZenonModulo---0.4.2's SOT_gUKYkR does not need preparation
ZenonModulo---0.4.2   will use /tmp/tv_v2i2OLB/SOT_gUKYkR
...
ZenonModulo---0.4.2   being executed on SOT_gUKYkR using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/tv_v2i2OLB/SOT_gUKYkR'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/tv_v2i2OLB/SOT_gUKYkR > /tmp/tmp.OoBxoR0PSJ/ZenonModulo_124146.s
% SZS status Theorem
...
RESULT: SOT_gUKYkR - ZenonModulo---0.4.2 says Theorem - CPU = 0.05 WC = 0.09 
OUTPUT: SOT_gUKYkR - ZenonModulo---0.4.2 says Proof - CPU = 0.05 WC = 0.09 
