...
ZenonModulo---0.4.2   checking problem name /tmp/mOKX2Wl0oP/SOT_MdpYKp

ZenonModulo---0.4.2's TPTP format /tmp/mOKX2Wl0oP/SOT_MdpYKp is ...
fof(c_0_7,axiom,
    ! [X9,X10,X11] :
...
ZenonModulo---0.4.2's SOT_MdpYKp does not need preparation
ZenonModulo---0.4.2   will use /tmp/mOKX2Wl0oP/SOT_MdpYKp
...
ZenonModulo---0.4.2   being executed on SOT_MdpYKp using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/mOKX2Wl0oP/SOT_MdpYKp'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/mOKX2Wl0oP/SOT_MdpYKp > /tmp/tmp.CfPAPPNUJa/ZenonModulo_124051.s
% SZS status Theorem
...
RESULT: SOT_MdpYKp - ZenonModulo---0.4.2 says Theorem - CPU = 0.05 WC = 0.08 
OUTPUT: SOT_MdpYKp - ZenonModulo---0.4.2 says Proof - CPU = 0.05 WC = 0.08 
