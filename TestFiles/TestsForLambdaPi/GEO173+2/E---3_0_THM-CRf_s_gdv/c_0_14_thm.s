...
ZenonModulo---0.4.2   checking problem name /tmp/zOJpKb9vmA/SOT_XuVcMO

ZenonModulo---0.4.2's TPTP format /tmp/zOJpKb9vmA/SOT_XuVcMO is ...
fof(c_0_8,axiom,
...
ZenonModulo---0.4.2's SOT_XuVcMO does not need preparation
ZenonModulo---0.4.2   will use /tmp/zOJpKb9vmA/SOT_XuVcMO
...
ZenonModulo---0.4.2   being executed on SOT_XuVcMO using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/zOJpKb9vmA/SOT_XuVcMO'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/zOJpKb9vmA/SOT_XuVcMO > /tmp/tmp.cwzL09CjLg/ZenonModulo_124364.s
% SZS status Theorem
...
rule S.c_0_14 ↪ λ c_0_5,
  ...
  nnpp (S.distinct_lines (S.esk3_0) (S.line_connecting (S.esk1_0) (S.esk2_0)))
    (λ (v_Vm : ϵ (¬
...
RESULT: SOT_XuVcMO - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.09 
OUTPUT: SOT_XuVcMO - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.09 
