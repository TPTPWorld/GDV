...
ZenonModulo---0.4.2   checking problem name /tmp/Pmb3Fc3I7q/SOT_Pu3MrV

ZenonModulo---0.4.2's TPTP format /tmp/Pmb3Fc3I7q/SOT_Pu3MrV is ...
fof(c_0_17,axiom,
    ! [X18,X19,X20] :
...
ZenonModulo---0.4.2's SOT_Pu3MrV does not need preparation
ZenonModulo---0.4.2   will use /tmp/Pmb3Fc3I7q/SOT_Pu3MrV
...
ZenonModulo---0.4.2   being executed on SOT_Pu3MrV using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/Pmb3Fc3I7q/SOT_Pu3MrV'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/Pmb3Fc3I7q/SOT_Pu3MrV > /tmp/tmp.cmIPiIggff/ZenonModulo_125150.s
% SZS status Theorem
% SZS output start Proof
require open Logic.Zenon.FOL Logic.Zenon.LL Logic.Zenon.ND Logic.Zenon.ND_eps Logic.Zenon.ND_eps_full Logic.Zenon.ND_eps_aux Logic.Zenon.LL_ND Logic.Zenon.zen;
require LAMBDAPI_CONTEXT.Signature as S;

rule S.c_0_24 ↪ λ c_0_5,
...
RESULT: SOT_Pu3MrV - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.07 
OUTPUT: SOT_Pu3MrV - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.07 
