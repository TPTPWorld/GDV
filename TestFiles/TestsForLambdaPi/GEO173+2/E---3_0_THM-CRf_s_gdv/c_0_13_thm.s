...
ZenonModulo---0.4.2   checking problem name /tmp/MJi_SkRwNy/SOT_LyC99s

ZenonModulo---0.4.2's TPTP format /tmp/MJi_SkRwNy/SOT_LyC99s is ...
fof(c_0_9,axiom,
    ! [X24,X25,X26,X27] :
...
ZenonModulo---0.4.2's SOT_LyC99s does not need preparation
ZenonModulo---0.4.2   will use /tmp/MJi_SkRwNy/SOT_LyC99s
...
ZenonModulo---0.4.2   being executed on SOT_LyC99s using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/MJi_SkRwNy/SOT_LyC99s'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/MJi_SkRwNy/SOT_LyC99s > /tmp/tmp.e3waXTXPLX/ZenonModulo_124275.s
% SZS status Theorem
...
RESULT: SOT_LyC99s - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.08 
OUTPUT: SOT_LyC99s - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.08 
