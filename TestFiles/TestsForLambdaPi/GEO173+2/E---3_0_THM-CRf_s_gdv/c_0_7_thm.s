...
ZenonModulo---0.4.2   checking problem name /tmp/kRRzQRKr8Y/SOT_r7PYTr

ZenonModulo---0.4.2's TPTP format /tmp/kRRzQRKr8Y/SOT_r7PYTr is ...
fof(apart4,axiom,
    ! [X1,X2,X3] :
...
ZenonModulo---0.4.2's SOT_r7PYTr does not need preparation
ZenonModulo---0.4.2   will use /tmp/kRRzQRKr8Y/SOT_r7PYTr
...
ZenonModulo---0.4.2   being executed on SOT_r7PYTr using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/kRRzQRKr8Y/SOT_r7PYTr'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/kRRzQRKr8Y/SOT_r7PYTr > /tmp/tmp.siCHCkhjDH/ZenonModulo_123664.s
% SZS status Theorem
...
RESULT: SOT_r7PYTr - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.09 
OUTPUT: SOT_r7PYTr - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.09 
