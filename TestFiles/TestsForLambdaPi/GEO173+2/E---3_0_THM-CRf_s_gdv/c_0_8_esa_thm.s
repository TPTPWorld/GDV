...
ZenonModulo---0.4.2   checking problem name /tmp/VjuQ0BfGid/SOT_a1XziX

ZenonModulo---0.4.2's TPTP format /tmp/VjuQ0BfGid/SOT_a1XziX is ...
fof(c_0_8,axiom,
...
ZenonModulo---0.4.2's SOT_a1XziX does not need preparation
ZenonModulo---0.4.2   will use /tmp/VjuQ0BfGid/SOT_a1XziX
...
ZenonModulo---0.4.2   being executed on SOT_a1XziX using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/VjuQ0BfGid/SOT_a1XziX'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/VjuQ0BfGid/SOT_a1XziX > /tmp/tmp.mcilwaXeil/ZenonModulo_123779.s
% SZS status Theorem
% SZS output start Proof
require open Logic.Zenon.FOL Logic.Zenon.LL Logic.Zenon.ND Logic.Zenon.ND_eps Logic.Zenon.ND_eps_full Logic.Zenon.ND_eps_aux Logic.Zenon.LL_ND Logic.Zenon.zen;
require LAMBDAPI_CONTEXT.Signature as S;

rule S.c_0_5 ↪ λ c_0_5,
...
RESULT: SOT_a1XziX - ZenonModulo---0.4.2 says Theorem - CPU = 0.00 WC = 0.10 
OUTPUT: SOT_a1XziX - ZenonModulo---0.4.2 says Proof - CPU = 0.00 WC = 0.10 
