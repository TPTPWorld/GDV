...
ZenonModulo---0.4.2   checking problem name /tmp/CuXbiLPWfl/SOT_ZF6rwM

ZenonModulo---0.4.2's TPTP format /tmp/CuXbiLPWfl/SOT_ZF6rwM is ...
fof(con1,axiom,
    ! [X1,X2,X3] :
...
ZenonModulo---0.4.2's SOT_ZF6rwM does not need preparation
ZenonModulo---0.4.2   will use /tmp/CuXbiLPWfl/SOT_ZF6rwM
...
ZenonModulo---0.4.2   being executed on SOT_ZF6rwM using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/CuXbiLPWfl/SOT_ZF6rwM'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/CuXbiLPWfl/SOT_ZF6rwM > /tmp/tmp.sLjsXsHsQf/ZenonModulo_124614.s
% SZS status Theorem
...
RESULT: SOT_ZF6rwM - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.11 
OUTPUT: SOT_ZF6rwM - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.12 
