...
ZenonModulo---0.4.2   checking problem name /tmp/z_7GXhSvrt/SOT_gt8uZp

ZenonModulo---0.4.2's TPTP format /tmp/z_7GXhSvrt/SOT_gt8uZp is ...
fof(con1,axiom,
    ! [X1,X2,X3] :
...
ZenonModulo---0.4.2's SOT_gt8uZp does not need preparation
ZenonModulo---0.4.2   will use /tmp/z_7GXhSvrt/SOT_gt8uZp
...
ZenonModulo---0.4.2   being executed on SOT_gt8uZp using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/z_7GXhSvrt/SOT_gt8uZp'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/z_7GXhSvrt/SOT_gt8uZp > /tmp/tmp.mRwS0tTt2U/ZenonModulo_10895.s
% SZS status Theorem
...
RESULT: SOT_gt8uZp - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.12 
OUTPUT: SOT_gt8uZp - ZenonModulo---0.4.2 says Proof - CPU = 0.09 WC = 0.12 
