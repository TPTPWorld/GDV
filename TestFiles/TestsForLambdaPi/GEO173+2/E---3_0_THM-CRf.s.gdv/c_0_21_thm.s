...
ZenonModulo---0.4.2   checking problem name /tmp/VBXOS0TCvJ/SOT_2ewFac

ZenonModulo---0.4.2's TPTP format /tmp/VBXOS0TCvJ/SOT_2ewFac is ...
fof(c_0_8,axiom,
...
ZenonModulo---0.4.2's SOT_2ewFac does not need preparation
ZenonModulo---0.4.2   will use /tmp/VBXOS0TCvJ/SOT_2ewFac
...
ZenonModulo---0.4.2   being executed on SOT_2ewFac using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/VBXOS0TCvJ/SOT_2ewFac'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/VBXOS0TCvJ/SOT_2ewFac > /tmp/tmp.W7yVDIR5TE/ZenonModulo_11248.s
% SZS status Theorem
...
RESULT: SOT_2ewFac - ZenonModulo---0.4.2 says Theorem - CPU = 0.00 WC = 0.08 
OUTPUT: SOT_2ewFac - ZenonModulo---0.4.2 says Proof - CPU = 0.00 WC = 0.08 
