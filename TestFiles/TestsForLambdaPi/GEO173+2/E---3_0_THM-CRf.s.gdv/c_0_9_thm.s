...
ZenonModulo---0.4.2   checking problem name /tmp/arPj_xw98Z/SOT_VscQ0y

ZenonModulo---0.4.2's TPTP format /tmp/arPj_xw98Z/SOT_VscQ0y is ...
fof(cu1,axiom,
    ! [X1,X2,X4,X5] :
...
ZenonModulo---0.4.2's SOT_VscQ0y does not need preparation
ZenonModulo---0.4.2   will use /tmp/arPj_xw98Z/SOT_VscQ0y
...
ZenonModulo---0.4.2   being executed on SOT_VscQ0y using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/arPj_xw98Z/SOT_VscQ0y'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/arPj_xw98Z/SOT_VscQ0y > /tmp/tmp.s7QYZdnPe0/ZenonModulo_10149.s
% SZS status Theorem
...
RESULT: SOT_VscQ0y - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.08 
OUTPUT: SOT_VscQ0y - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.08 
