...
ZenonModulo---0.4.2   checking problem name /tmp/uM9pLQ_nRG/SOT_sbew7o

ZenonModulo---0.4.2's TPTP format /tmp/uM9pLQ_nRG/SOT_sbew7o is ...
fof(c_0_8,axiom,
...
ZenonModulo---0.4.2's SOT_sbew7o does not need preparation
ZenonModulo---0.4.2   will use /tmp/uM9pLQ_nRG/SOT_sbew7o
...
ZenonModulo---0.4.2   being executed on SOT_sbew7o using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/uM9pLQ_nRG/SOT_sbew7o'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/uM9pLQ_nRG/SOT_sbew7o > /tmp/tmp.aLExXb1dzg/ZenonModulo_10630.s
% SZS status Theorem
...
RESULT: SOT_sbew7o - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.07 
OUTPUT: SOT_sbew7o - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.07 
