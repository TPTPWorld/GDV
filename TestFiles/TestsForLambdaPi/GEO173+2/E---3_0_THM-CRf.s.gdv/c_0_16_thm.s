...
ZenonModulo---0.4.2   checking problem name /tmp/pzQYm7Cmcq/SOT_3YO7rC

ZenonModulo---0.4.2's TPTP format /tmp/pzQYm7Cmcq/SOT_3YO7rC is ...
fof(c_0_11,axiom,
    ! [X2,X3,X1] :
...
ZenonModulo---0.4.2's SOT_3YO7rC does not need preparation
ZenonModulo---0.4.2   will use /tmp/pzQYm7Cmcq/SOT_3YO7rC
...
ZenonModulo---0.4.2   being executed on SOT_3YO7rC using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/pzQYm7Cmcq/SOT_3YO7rC'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/pzQYm7Cmcq/SOT_3YO7rC > /tmp/tmp.76TEm6Dyqw/ZenonModulo_10829.s
% SZS status Theorem
...
RESULT: SOT_3YO7rC - ZenonModulo---0.4.2 says Theorem - CPU = 0.00 WC = 0.09 
OUTPUT: SOT_3YO7rC - ZenonModulo---0.4.2 says Proof - CPU = 0.00 WC = 0.09 
