...
ZenonModulo---0.4.2   checking problem name /tmp/iWTopLSXQL/SOT_krv_OT

ZenonModulo---0.4.2's TPTP format /tmp/iWTopLSXQL/SOT_krv_OT is ...
fof(c_0_8,axiom,
...
ZenonModulo---0.4.2's SOT_krv_OT does not need preparation
ZenonModulo---0.4.2   will use /tmp/iWTopLSXQL/SOT_krv_OT
...
ZenonModulo---0.4.2   being executed on SOT_krv_OT using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/iWTopLSXQL/SOT_krv_OT'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/iWTopLSXQL/SOT_krv_OT > /tmp/tmp.kd1c9kvuvV/ZenonModulo_10059.s
% SZS status Theorem
...
RESULT: SOT_krv_OT - ZenonModulo---0.4.2 says Theorem - CPU = 0.07 WC = 0.09 
OUTPUT: SOT_krv_OT - ZenonModulo---0.4.2 says Proof - CPU = 0.07 WC = 0.09 
