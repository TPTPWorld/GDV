...
ZenonModulo---0.4.2   checking problem name /tmp/WtqThpfoYj/SOT_M8CBck

ZenonModulo---0.4.2's TPTP format /tmp/WtqThpfoYj/SOT_M8CBck is ...
fof(c_0_18,axiom,
    ! [X2,X1] :
...
ZenonModulo---0.4.2's SOT_M8CBck does not need preparation
ZenonModulo---0.4.2   will use /tmp/WtqThpfoYj/SOT_M8CBck
...
ZenonModulo---0.4.2   being executed on SOT_M8CBck using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/WtqThpfoYj/SOT_M8CBck'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/WtqThpfoYj/SOT_M8CBck > /tmp/tmp.yDZqVMSXeT/ZenonModulo_11379.s
% SZS status Theorem
...
RESULT: SOT_M8CBck - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.09 
OUTPUT: SOT_M8CBck - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.09 
