...
ZenonModulo---0.4.2   checking problem name /tmp/L7vFq8gzQh/SOT_TOwimm

ZenonModulo---0.4.2's TPTP format /tmp/L7vFq8gzQh/SOT_TOwimm is ...
fof(c_0_24,axiom,
    ! [X3,X2,X1] :
...
ZenonModulo---0.4.2's SOT_TOwimm does not need preparation
ZenonModulo---0.4.2   will use /tmp/L7vFq8gzQh/SOT_TOwimm
...
ZenonModulo---0.4.2   being executed on SOT_TOwimm using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/L7vFq8gzQh/SOT_TOwimm'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/L7vFq8gzQh/SOT_TOwimm > /tmp/tmp.Dux1m0Iic4/ZenonModulo_11578.s
% SZS status Theorem
...
RESULT: SOT_TOwimm - ZenonModulo---0.4.2 says Theorem - CPU = 0.00 WC = 0.08 
OUTPUT: SOT_TOwimm - ZenonModulo---0.4.2 says Proof - CPU = 0.00 WC = 0.08 
