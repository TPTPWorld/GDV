...
ZenonModulo---0.4.2   checking problem name /tmp/wAy_e5JNmw/SOT_sWncz_

ZenonModulo---0.4.2's TPTP format /tmp/wAy_e5JNmw/SOT_sWncz_ is ...
fof(c_0_17,axiom,
    ! [X18,X19,X20] :
...
ZenonModulo---0.4.2's SOT_sWncz_ does not need preparation
ZenonModulo---0.4.2   will use /tmp/wAy_e5JNmw/SOT_sWncz_
...
ZenonModulo---0.4.2   being executed on SOT_sWncz_ using /home/tptp/Systems/ZenonModulo---0.4.2/run_zenon_modulo 60 '/tmp/wAy_e5JNmw/SOT_sWncz_'
% START OF SYSTEM OUTPUT
Running zenon_modulo -p0 -itptp -olpterm -x arith -neg-conj=c_0_5  -max-time 60s -max-size 12G -sig LAMBDAPI_CONTEXT.Signature /tmp/wAy_e5JNmw/SOT_sWncz_ > /tmp/tmp.FpkSeHhmDK/ZenonModulo_11449.s
% SZS status Theorem
...
RESULT: SOT_sWncz_ - ZenonModulo---0.4.2 says Theorem - CPU = 0.01 WC = 0.09 
OUTPUT: SOT_sWncz_ - ZenonModulo---0.4.2 says Proof - CPU = 0.01 WC = 0.10 
