...
E---3.1   checking problem name TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/coordinator_teaches_thm.p

E---3.1's TPTP format TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/coordinator_teaches_thm.p is ...
...
tff(coordinator_teaches,conjecture,
    ! [X8: course] : teaches(coordinatorof(X8),X8),
    file('/export/starexec/sandbox2/benchmark/theBenchmark.p',coordinator_teaches) ).

E---3.1's coordinator_teaches_thm does not need preparation
E---3.1   will use TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/coordinator_teaches_thm.p
...
E---3.1   being executed on coordinator_teaches_thm using /exp/home/tptp/Systems/E---3.1/run_E 'TestsForLambdaPi/PUZ131_1/E---3.0.THM-CRf.s_gdv/coordinator_teaches_thm.p' 30 THM
% START OF SYSTEM OUTPUT
Running first-order theorem proving
Running: /exp/home/tptp/Systems/E---3.1/eprover --delete-bad-limit=2000000000 --definitional-cnf=24 -s --print-statistics -R --print-version --proof-object --auto-schedule=8 --cpu-limit=30 /tmp/tmp.Ynt4zXsXR7/E---3.1_50998
# Version: 3.1pre001
...
# new_bool_3 with pid 51017 completed with status 0
...
# G-E--_208_C18_F1_SE_CS_SP_PS_S5PRR_S4d with pid 51022 completed with status 0
...
tff(coordinator_teaches, conjecture, ![X10:course]:(teaches(coordinatorof(X10),X10)), file('/tmp/tmp.Ynt4zXsXR7/E---3.1_50998', coordinator_teaches)).
tff(coordinator_teaches_0015, axiom, ![X8:course]:(teaches(coordinatorof(X8),X8)), file('/tmp/tmp.Ynt4zXsXR7/E---3.1_50998', coordinator_teaches_0015)).
tff(c_0_2, negated_conjecture, ~(![X10:course]:(teaches(coordinatorof(X10),X10))), inference(assume_negation,[status(cth)],[coordinator_teaches])).
tff(c_0_3, negated_conjecture, ~teaches(coordinatorof(esk1_0),esk1_0), inference(skolemize,[status(esa)],[inference(variable_rename,[status(thm)],[inference(fof_nnf,[status(thm)],[c_0_2])])])).
tff(c_0_4, plain, ![X16:course]:(teaches(coordinatorof(X16),X16)), inference(variable_rename,[status(thm)],[coordinator_teaches_0015])).
tcf(c_0_5, negated_conjecture, ~teaches(coordinatorof(esk1_0),esk1_0), inference(split_conjunct,[status(thm)],[c_0_3])).
tcf(c_0_6, plain, ![X2:course]:(teaches(coordinatorof(X2),X2)), inference(split_conjunct,[status(thm)],[c_0_4])).
cnf(c_0_7, negated_conjecture, ($false), inference(cn,[status(thm)],[inference(rw,[status(thm)],[c_0_5, c_0_6])]), ['proof']).
...
RESULT: coordinator_teaches_thm - E---3.1 says Theorem - CPU = 0.08 WC = 0.10 
OUTPUT: coordinator_teaches_thm - E---3.1 says CNFRefutation - CPU = 0.08 WC = 0.10 
